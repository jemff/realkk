...
\end{proposition}
To construct cycles representing the generators of the real $K$-homology groups, it suffices to construct unbounded elliptic operators with the appropriate kernels. 
\begin{theorem}
